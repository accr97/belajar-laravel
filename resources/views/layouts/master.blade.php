...
<head>
  ...
  <!-- CSS Libraries -->
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{ url('/') }}/assets/vendor/jqvmap/dist/jqvmap.min.css">
    <link rel="stylesheet" href="{{ url('/') }}/assets/vendor/summernote/dist/summernote-bs4.css">
    <link rel="stylesheet" href="{{ url('/') }}/assets/vendor/owl.carousel/dist/assets/owl.carousel.min.css">
    <link rel="stylesheet" href="{{ url('/') }}/assets/vendor/owl.carousel/dist/assets/owl.theme.default.min.css">
    <link rel="stylesheet" href="{{ url('/') }}/assets/vendor/chocolat/dist/css/chocolat.css">
    ...
    <link href="{{ url('/') }}/assets/vendor/sweetalert/sweetalert2.min.css" rel="stylesheet" />
