...
if (typeof process !== 'undefined' && typeof process.cwd === 'function') {
  var join = path.join
    , cwd = process.cwd();
  module.paths.push(cwd, join(cwd, 'vendor'));
}
 ...
 * (i.e: strip Mocha, vendor, bower and componentJS from stack trace).
 * @returns {Function}
 */
...
exports.stackTraceFilter = function() {
  ...
  function isNodeModule (line) {
    return (~line.indexOf('vendor'));
  }

  function isMochaInternal (line) {
    return (~line.indexOf('vendor' + slash + 'mocha'))  ||
      (~line.indexOf('components' + slash + 'mochajs'))       ||
      (~line.indexOf('components' + slash + 'mocha'));
  }

  // vendor, bower, componentJS
